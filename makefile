...
os:
	...
	ld -m elf_i386 main.o memory.o message.o schedule.o task.o interrupt.o x86.o x86_memory.o x86_lib_s.o x86_interrupt.o x86_interrupt_s.o x86_task.o -o sys.bin -Ttext 0x200000 -e main --oformat binary
